...
func TestActuatorReferenceAliasResolution(t *testing.T) {
	cases := []struct {
		...
		{FlatlandSpeakActuatorAliasName, FlatlandSpeakActuatorName, "flatland"},
		{FlatlandGestaltActuatorAliasName, FlatlandGestaltActuatorName, "flatland"},
		{FlatlandSpearActuatorAliasName, FlatlandSpearActuatorName, "flatland"},
		{FlatlandShootActuatorAliasName, FlatlandShootActuatorName, "flatland"},
		{FlatlandCreateOffspringActuatorAliasName, FlatlandCreateOffspringActuatorName, "flatland"},
