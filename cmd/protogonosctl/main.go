...
func defaultMutationPolicy(
	...
	return []evo.WeightedMutation{
		...
		{Operator: &evo.AddRandomNeuron{Rand: rand.New(rand.NewSource(seed + 1005))}, Weight: wAddNeuron * 0.40},
		...
		{Operator: &evo.ChangePlasticityRule{Rand: rand.New(rand.NewSource(seed + 1021))}, Weight: wPlasticityRule},
		{Operator: &evo.PerturbPlasticityRate{Rand: rand.New(rand.NewSource(seed + 1022)), MaxDelta: 0.15}, Weight: wPlasticity},
		{Operator: &evo.AddRandomSensor{Rand: rand.New(rand.NewSource(seed + 1008)), ScapeName: scapeName}, Weight: wSubstrate * 0.08},
		{Operator: &evo.AddRandomSensorLink{Rand: rand.New(rand.NewSource(seed + 1009)), ScapeName: scapeName}, Weight: wSubstrate * 0.08},
		{Operator: &evo.AddRandomActuator{Rand: rand.New(rand.NewSource(seed + 1010)), ScapeName: scapeName}, Weight: wSubstrate * 0.08},
		{Operator: &evo.AddRandomActuatorLink{Rand: rand.New(rand.NewSource(seed + 1011)), ScapeName: scapeName}, Weight: wSubstrate * 0.08},
		{Operator: &evo.RemoveRandomSensor{Rand: rand.New(rand.NewSource(seed + 1012))}, Weight: wSubstrate * 0.07},
		{Operator: &evo.CutlinkFromSensorToNeuron{Rand: rand.New(rand.NewSource(seed + 1013))}, Weight: wSubstrate * 0.07},
		{Operator: &evo.RemoveRandomActuator{Rand: rand.New(rand.NewSource(seed + 1014))}, Weight: wSubstrate * 0.07},
		{Operator: &evo.CutlinkFromNeuronToActuator{Rand: rand.New(rand.NewSource(seed + 1015))}, Weight: wSubstrate * 0.07},
		{Operator: &evo.AddRandomCPP{Rand: rand.New(rand.NewSource(seed + 1016))}, Weight: wSubstrate * 0.06},
		{Operator: &evo.RemoveRandomCPP{}, Weight: wSubstrate * 0.04},
		{Operator: &evo.AddRandomCEP{Rand: rand.New(rand.NewSource(seed + 1017))}, Weight: wSubstrate * 0.06},
		{Operator: &evo.RemoveRandomCEP{}, Weight: wSubstrate * 0.04},
