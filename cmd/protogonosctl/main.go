...
func defaultMutationPolicy(
	...
	return []evo.WeightedMutation{
		...
		{Operator: &evo.RemoveRandomInlink{Rand: rand.New(rand.NewSource(seed + 1003)), InputNeuronIDs: inputNeuronIDs}, Weight: wRemoveSynapse / 3},
		{Operator: &evo.RemoveRandomOutlink{Rand: rand.New(rand.NewSource(seed + 1004)), OutputNeuronIDs: outputNeuronIDs}, Weight: wRemoveSynapse / 3},
