...
func materializeRunConfigFromRequest(req RunRequest) (materializedRunConfig, error) {
	...
	if req.WeightPerturb == 0 && req.WeightBias == 0 && req.WeightAddSynapse == 0 && req.WeightRemoveSynapse == 0 && req.WeightAddNeuron == 0 && req.WeightRemoveNeuron == 0 && req.WeightPlasticity == 0 && req.WeightSubstrate == 0 {
	...
	if req.WeightPerturb+req.WeightBias+req.WeightAddSynapse+req.WeightRemoveSynapse+req.WeightAddNeuron+req.WeightRemoveNeuron+req.WeightPlasticity+req.WeightSubstrate <= 0 {
...
func defaultMutationPolicy(seed int64, inputNeuronIDs, outputNeuronIDs []string, req RunRequest) []evo.WeightedMutation {
	...
	return []evo.WeightedMutation{
		...
		{Operator: &evo.PerturbPlasticityRate{Rand: rand.New(rand.NewSource(seed + 1005)), MaxDelta: 0.15}, Weight: req.WeightPlasticity},
		{Operator: &evo.PerturbSubstrateParameter{Rand: rand.New(rand.NewSource(seed + 1006)), MaxDelta: 0.15}, Weight: req.WeightSubstrate},
	}
}
