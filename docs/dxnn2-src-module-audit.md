...
| `selection_algorithm.erl` | selection strategy variants | `internal/evo/selection.go` + monitor integration + CLI/API alias mapping (`hof_competition`/`competition`/`top3`) | `partial` | `internal/evo/selection.go`, `internal/evo/population_monitor.go`, `cmd/protogonosctl/main.go`, `pkg/protogonos/api.go`, `.ref/src/selection_algorithm.erl` |
...
| `fitness_postprocessor.erl` | post-fitness adjustment (size/novelty) | `internal/evo/fitness_postprocessor.go` + monitor integration + CLI/API alias mapping (`nsize_proportional`) | `partial` | `internal/evo/fitness_postprocessor.go`, `internal/evo/population_monitor.go`, `cmd/protogonosctl/main.go`, `pkg/protogonos/api.go`, `.ref/src/fitness_postprocessor.erl` |
