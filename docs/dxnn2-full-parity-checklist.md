...
| `exoself.erl` | `partial` | Bounded exoself tuning loop integrated with attempts/policies and minimum-improvement acceptance threshold (`MIN_PIMPROVEMENT`-style gating); full orchestration parity still pending. |
